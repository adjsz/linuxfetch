...
def show_logo():
    ...
    if "linux" in os_info:
        ...
        if "mint" in distro_name:
            ...
            logo_file = os.path.join(script_dir, "logos", "debian.txt") # Debian
        elif "arch" in distro_name:
            logo_file = os.path.join(script_dir, "logos", "arch.txt") # Arch Linux
        elif "fedora" in distro_name:
            logo_file = os.path.join(script_dir, "logos", "fedora.txt") # Fedora Linux
        else:
    ...
    try:
        ...
        console.print("[bold red]Error:[/bold red] Logo file not found") # if .txt does not exist, or file path is wrong
